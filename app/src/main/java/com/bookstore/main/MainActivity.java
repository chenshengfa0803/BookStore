...
public class MainActivity extends Activity {
    ...
    public void createFloatButtonMenu() {
        ...
        //ImageView floatButtonIcon = new ImageView(this);
        //floatButtonIcon.setImageDrawable(getResources().getDrawable(R.drawable.main_floatbutton_add));
        //mainFloatButton.setContentView(floatButtonIcon, null);
